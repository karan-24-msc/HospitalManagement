...
document.addEventListener("DOMContentLoaded", function() {
    document.querySelectorAll('.sidebar-submenu').forEach(e => {
        e.querySelector('.sidebar-menu-dropdown').onclick = (event) => {
            ...
            e.querySelector('.dropdown-icon').classList.toggle('active');

            let dropdownContent = e.querySelector('.sidebar-menu-dropdown-content');
            let dropdownContentLis = dropdownContent.querySelectorAll('li');
            let activeHeight = dropdownContentLis[0].clientHeight * dropdownContentLis.length;
