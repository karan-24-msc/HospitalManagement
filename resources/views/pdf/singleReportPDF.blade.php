...
<div class="container">
    ...
    <!-- Report Sections -->
    @if($reportName === 'ultra_snow_gram' || $reportName === 'x_ray' || $reportName === 'ecg' || $reportName === 'eco_ett' || $reportName === 'c_t_scan' || $reportName === 'others')
        <div class="section">
            <h2>{{ strtoupper(str_replace('_', ' ', $reportName)) }}</h2>
            <table class="report-table">
                ...
                <tbody>
                @foreach (json_decode($report, true) as $test)
    ...
    @else
        ...
        <div class="section">
            ...
            <table class="report-table">
                ...
                <tbody>
                @foreach ( json_decode($report, true)[0] as $section => $tests)
