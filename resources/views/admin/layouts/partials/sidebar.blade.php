...
{{--                <img src="{{ asset('assets/admin/assets/images/users/avatar-1.jpg') }}" alt="" class="img-circle">--}}
            </div>
            <div class="user-info">
                <div class="dropdown">
                    <a href="{{ route('admin.dashboard') }}" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">{{ auth()->guard('admin')->user()->name }}</a>
        ...
        <div id="sidebar-menu">
            <ul>
                <li>
                    <a href="{{ route('admin.dashboard') }}" class="waves-effect {{ ($route == 'admin.dashboard') ? 'active':'' }}"><i class="ti-home"></i><span> Dashboard </span></a>
                </li>
...
{{--                </li>--}}
                ...
                <li class="has_sub">
                    <a href="javascript:void(0);" class="waves-effect  {{ ($prefix == 'admin/settings')? 'active subdrop':'' }}"><i class="ti-settings"></i> <span> Site Settings </span> <span class="pull-right"><i class="mdi mdi-plus"></i></span></a>
                    <ul class="list-unstyled">
                        <li class="{{ ($route == 'information')? 'active':'' }}">
                            <a class="{{ ($route == 'information') ? 'active':'' }}" href="{{ route('information') }}">Company Information</a>
                        </li>
{{--                        <li>--}}
...
{{--                        </li>--}}
                ...
                <li class="has_sub">
                    <a href="javascript:void(0);" class="waves-effect  {{ ($prefix == 'admin/staff')? 'active subdrop':'' }}"><i class="ion-person"></i> <span> Staff Management </span> <span class="pull-right"><i class="mdi mdi-plus"></i></span></a>
                    <ul class="list-unstyled">
                        <li class="{{ ($route == 'staff.list')? 'active':'' }}">
                            <a class="{{ ($route == 'staff.list') ? 'active':'' }}" href="{{ route('staff.list') }}">Staff List</a>
                        </li>
                        <li class="{{ ($route == 'staff.add') ? 'active':'' }}">
                            <a class="{{ ($route == 'staff.add') ? 'active':'' }}" href="{{ route('staff.add') }}">Staff Add</a>
                        </li>
                    </ul>
                </li>

                <li>
                    <a href="{{ route('department.index') }}" class="waves-effect {{ ($route == 'department.index') ? 'active':'' }}"><i class="ti-home"></i><span> Manage Department </span></a>
                </li>

                <li>
                    <a href="{{ route('unit.index') }}" class="waves-effect {{ ($route == 'unit.index') ? 'active':'' }}"><i class="ti-home"></i><span> Manage Units </span></a>
                </li>

                <li>
                    <a href="{{ route('bed.index') }}" class="waves-effect {{ ($route == 'bed.index') ? 'active':'' }}"><i class="ti-home"></i><span> Manage Beds </span></a>
                </li>

                <li>
                    <a href="{{ route('admin.patient_appointment') }}" class="waves-effect {{ ($route == 'admin.patient_appointment') ? 'active':'' }}"><i class="ti-panel"></i><span> Patients Booking </span></a>
                </li>

                <li>
                    <a href="{{ route('contact.message') }}" class="waves-effect {{ ($route == 'contact.message') ? 'active':'' }}"><i class="ti-panel"></i><span> Contact Messages </span></a>
                </li>
